...
class WeatherApi::ServiceTest < ActiveSupport::TestCase
  ...
  #   results = WeatherApi::Service.call(nil, nil)
  #   assert_nil results
  # end

  # test "no units returns nil" do
  #   results = WeatherApi::Service.call("Saskatoon", nil)
  #   assert_nil results
  # end

  # test "invalid units returns nil" do
  #   results = WeatherApi::Service.call("Saskatoon", "abc")
  #   assert_nil results
  # end
  ...
  #     results = WeatherApi::Service.call("Saskatoon", "metric")
